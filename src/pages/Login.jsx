            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="#">
                    <div>
                        ...
                        <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded  outline-none focus:ring-green-700 focus:border-green-700 block w-full p-2.5" placeholder="name@company.com" required />
                    </div>
                    <div>
                    ...
                    <div class="flex items-center justify-start">
                        ...
                        <a href="#" class="text-sm font-medium text-green-700 hover:underline ">htmlForgot password?</a>
                    </div>
                    ...
                    <p class="text-sm font-light text-gray-500 ">
                        Don’t have an account yet? <a href="#" class="font-medium text-green-700 hover:underline ">Sign up</a>
                    </p>
                </form>
            </div>
        </div>
