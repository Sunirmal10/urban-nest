  ...
  return (
    <div className='flex flex-col mt-20 mb-5 px-5'>
      ...
      <div className='flex flex-col w-1/2 gap-5 justify-start'>
        <div className='font-bold text-xl'>Winter Jacket</div>
        ...
        <div className='flex w-32 mt-20 h-12 border border-slate-400 text-slate-500 justify-center items-center cursor-pointer hover:bg-green-700 hover:text-white hover:border-green-700'>ADD TO CART</div>
        </div>  
        </div>
